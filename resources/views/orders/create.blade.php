    ...
    <div class="p-6 max-w-2xl">
        <form method="POST" action="{{ route('orders.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="amount" name="amount" value="{{ old('amount') }}" step="0.01" min="0" class="w-full px-4 py-2 border rounded @error('amount') border-red-500 @enderror" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="order_date" name="order_date" value="{{ old('order_date') }}" class="w-full px-4 py-2 border rounded @error('order_date') border-red-500 @enderror" required>
